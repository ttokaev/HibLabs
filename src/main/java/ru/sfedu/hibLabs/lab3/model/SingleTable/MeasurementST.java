...
@Entity(name = "MeasurementST")
@Table(schema = "lab3_st")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorValue("null")
public class MeasurementST {
    @Id
    ...
    public MeasurementST() {
    }

    public MeasurementST(String g) {
        this.gender = g;
    }

    public MeasurementST(double weight, double height, int age, String gender) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MeasurementST)) return false;
        MeasurementST that = (MeasurementST) o;
