...
public class MeasurementMS {
        ...
        public MeasurementMS() {
        }

        public MeasurementMS(String g) {
            this.gender = g;
        }

        public MeasurementMS(double weight, double height, int age, String gender) {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof MeasurementMS)) return false;
            MeasurementMS that = (MeasurementMS) o;
