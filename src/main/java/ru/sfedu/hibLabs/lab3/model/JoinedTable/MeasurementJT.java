...
@Entity(name = "MeasurementJT")
@Inheritance(strategy = InheritanceType.JOINED)
public class MeasurementJT {
    @Id
    ...
    public MeasurementJT() {
    }

    public MeasurementJT(String g) {
        this.gender = g;
    }

    public MeasurementJT(double weight, double height, int age, String gender) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MeasurementJT)) return false;
        MeasurementJT that = (MeasurementJT) o;
