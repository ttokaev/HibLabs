...
public class UserColTest {
    private static Logger log = LogManager.getLogger(UserColTest.class);
    ...
    public static void initRecord(DataProviderHB4 dp) {
        ...
        UserCol User = createDefaultUser();
        dp.addRecord(User);
    }
    ...
    public static UserCol createDefaultUser(){
        UserCol User = new UserCol();
        Measurement measurement = createDefaultMeasurement();
        User.setName("Tim");
        User.setSurname("Tok");
        Set<Measurement> weight = new HashSet<>();
        weight.add(measurement);
        User.setWeight(weight);
        return User;
    }

    public static Measurement createDefaultMeasurement(){
        Measurement measurement = new Measurement();
        measurement.setAge(18);
        measurement.setHeight(180);
        measurement.setWeight(79);
        return measurement;
    }
}